...
safeItem =
    sat consumerLS (\v -> not (isDelim <| .val v))
    ...
    let
        ...
        ( classDict, idDict, pseudoDict, tagDict ) =
            List.foldl populate
                ...
                indexedNodes
    in
        IndexedCss (Dict.fromList indexedNodes)
            classDict
            idDict
            pseudoDict
            tagDict
