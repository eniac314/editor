...
many_ : (( a, b ) -> Parser c ( a, b )) -> ( a, b ) -> (( a, b ) -> ( d, b ) -> ( d, b )) -> d -> Parser c ( d, b )
many_ p acc f ie =
    (many1_ p acc f ie) +++ return ( ie, Tuple.second acc )


many1_ : (( a, b ) -> Parser c ( a, b )) -> ( a, b ) -> (( a, b ) -> ( d, b ) -> ( d, b )) -> d -> Parser c ( d, b )
many1_ p acc f ie =
    p acc >>= (\v -> many_ p v f ie >>= (\vs -> return (f v vs)))
