...
toAttr a =
    case a of
        ...
        Form_ s ->
            Html.Attributes.form s

        Max s ->
            Html.Attributes.max s

        Min s ->
            Html.Attributes.min s
    ...
    let
        ...
        f buff xs =
            case xs of
                ...
                x :: xs ->
                    if (x == ' ') then
                        ( String.fromList (List.reverse buff), String.fromList xs )
                    else
                        f (x :: buff) xs
    in
        f [] s
